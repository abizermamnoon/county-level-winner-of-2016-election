...
rf <- randomForest(fare_amount ~ pickup_latitude_mod+pickup_longitude_mod+ dropoff_latitude_mod+ dropoff_longitude_mod+ passenger_count+pickup_time+distance+cluster_pickup+cluster_dropoff+pickup_month+pickup_date+n, data=uber_dist_2015, ntree = 500, mtry=5)
