...
mypacks <- c("ggplot2","dplyr","readr","tidyr", "ROCR", "boot","class","randomForest","e1071", "stringr","partykit","rpart","plyr","pracma","leaflet", "maps", "rgdal", "rgeos","leaflet", "tree","doParallel","foreach","ggmap")  # what packages are needed?
...
```
Through the map above, we can see the distribution of pickup and drop-off locations in New York in our dataset. Cluster 1 can be defined as Downtown and Brooklyn area, cluster 2 would be considered Queens, Cluster 3 would be defined as the Upper East Side and West Side stretching up to the Bronx and cluster 4 would be defined as Midtown. This is useful because it shows which areas of New York city our model will be useful for the most. However, the pickup and dropoff clusters do not tell us anything regarding direction. 
